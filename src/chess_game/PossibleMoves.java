...
public class PossibleMoves {
    ...
    public static ArrayList listOfMovesConsideringAllThreatendFields(int row, int column, Square[][] square)
            throws Exception {
        ...
        if (current.getType().equals("pawn")) {
            ...
            return Bishop.fieldsThreatendByTheBishopSkippingKingsPosition(row, column, possibleFields, square);

        } else if (current.getType().equals("knight")) {
            possibleFields.clear();
            return Knight.knightMovesAllThreatenedFields(row, column, possibleFields, square);
            ...
            return Rook.fieldsThreatendByTheRookSkippingKingsPosition(row, column, possibleFields, square);
        } else
